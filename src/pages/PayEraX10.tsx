              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    target.onerror = null;
                    target.src = "https://via.placeholder.com/400x560/0097A7/FFFFFF?text=PayEra+X10";
                  }}
                />
              </div>
            </div>
            ...
            <div className="bg-bg-light p-4 rounded-lg shadow-md">
              <img 
                ...
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  target.onerror = null;
                  target.src = "https://via.placeholder.com/600x400/0097A7/FFFFFF?text=PayEra+X10+Ön";
                }}
              />
            </div>
            <div className="bg-bg-light p-4 rounded-lg shadow-md">
              <img 
                ...
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  target.onerror = null;
                  target.src = "https://via.placeholder.com/600x400/0097A7/FFFFFF?text=PayEra+X10+Yan";
                }}
              />
            </div>
            <div className="bg-bg-light p-4 rounded-lg shadow-md">
              <img 
                ...
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  target.onerror = null;
                  target.src = "https://via.placeholder.com/600x400/0097A7/FFFFFF?text=PayEra+X10+Detay";
                }}
              />
            </div>
          </div>
