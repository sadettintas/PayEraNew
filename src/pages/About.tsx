        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              <h2 className="text-2xl font-bold text-navy mb-6">Şirket Hikayemiz</h2>
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="p-8 border-b md:border-b-0 md:border-r border-gray-200">
              ...
              <h2 className="text-xl font-bold text-navy mb-4 text-center">Vizyonumuz</h2>
            ...
            <div className="p-8">
              ...
              <h2 className="text-xl font-bold text-navy mb-4 text-center">Misyonumuz</h2>
              <p className="text-gray-700 text-center">
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="py-6 px-4 border-b border-gray-200">
              <h3 className="text-xl font-bold text-navy mb-3">Müşteri Odaklılık</h3>
            ...
            <div className="py-6 px-4 border-b border-gray-200">
              <h3 className="text-xl font-bold text-navy mb-3">Yenilikçilik</h3>
              <p className="text-gray-700">
            ...
            <div className="py-6 px-4 border-b border-gray-200">
              <h3 className="text-xl font-bold text-navy mb-3">Kalite</h3>
              <p className="text-gray-700">
            ...
            <div className="py-6 px-4 border-b border-gray-200">
              <h3 className="text-xl font-bold text-navy mb-3">Güvenilirlik</h3>
              <p className="text-gray-700">
            ...
            <div className="py-6 px-4 border-b border-gray-200">
              <h3 className="text-xl font-bold text-navy mb-3">Sürdürülebilirlik</h3>
              <p className="text-gray-700">
            ...
            <div className="py-6 px-4 border-b border-gray-200">
              <h3 className="text-xl font-bold text-navy mb-3">Takım Çalışması</h3>
              <p className="text-gray-700">
