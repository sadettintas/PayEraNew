    ...
    <>
      ...
      <section className="pt-24 pb-16 bg-navy text-white relative overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Hakkımızda - PayEra</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div 
                ...
                data-event="value-card-click"
                data-value-id={value.title.toLowerCase().replace(/\s+/g, '-')}
              >
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/3 relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <h3 className="text-2xl font-bold">Nurullah Türk</h3>
                  <p className="text-white opacity-80">Yönetim Kurulu Başkanı</p>
                </div>
              </div>
              
              {/* Right Column - Quote */}
              <div className="md:w-2/3 p-8 md:p-12 flex items-center bg-[#F8F9FA]">
                <blockquote className="relative">
                  <div className="text-6xl text-turquoise absolute -top-8 -left-6 opacity-20">"</div>
                  ...
                  <footer className="text-right font-semibold text-navy">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div 
                ...
                data-event="team-member-profile-click"
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-navy opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  
                  {/* Icon badge */}
                  <div className="absolute top-4 right-4 bg-turquoise text-white rounded-full w-8 h-8 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-4 group-hover:translate-x-0">
                    <span>{member.icon}</span>
                  </div>
                </div>
                
                <div className="p-6">
                  <h3 className="text-xl font-bold text-navy mb-1 group-hover:text-turquoise transition-colors duration-300">{member.name}</h3>
                  <p className="text-turquoise mb-3">{member.position}</p>
      ...
      <section className="py-16 bg-navy text-white">
        <div className="max-w-screen-xl mx-auto px-4 text-center">
          ...
          <Link 
            to="/kariyer" 
            className="bg-turquoise hover:bg-cyan-700 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 inline-block shadow-lg hover:shadow-xl transform hover:scale-105"
            data-event="career-btn-click"
