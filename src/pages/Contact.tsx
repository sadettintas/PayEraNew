  ...
  return (
    <>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/3 mb-10 lg:mb-0 lg:pr-10">
              <h2 className="text-2xl font-bold text-navy mb-6">İletişim Bilgileri</h2>
              ...
              <div className="mt-10">
                <h3 className="text-xl font-bold text-navy mb-4">Bizi Takip Edin</h3>
                <div className="flex space-x-4">
                  <a href="#" className="bg-navy hover:bg-turquoise text-white p-2 rounded-full transition duration-300">
      ...
      <section className="py-16 bg-light-gray">
        <div className="container mx-auto px-6">
          <h2 className="text-2xl font-bold text-navy mb-6 text-center">Konumumuz</h2>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="relative w-full h-96">
              ...
              ></iframe>
              <div className="absolute top-4 left-4 text-center text-gray-500 bg-white bg-opacity-90 p-3 rounded-lg shadow-md z-20">
                <h3 className="text-md font-bold text-navy mb-1">PayEra Genel Merkez</h3>
                <p className="text-sm text-gray-600 max-w-xs">Küçükbakkalköy Mah. Beyazıt Sk. Kandiş Plaza No:22 İç Kapı No:2, 34750 Ataşehir/İstanbul</p>
              </div>
            </div>
          </div>
        </div>
